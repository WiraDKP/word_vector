# Word Vector by J.COp
# Starter Guide

## Step 1: Download materi
- Klik disini untuk [Download ZIP](https://codeload.github.com/WiraDKP/word_vector/zip/master), atau
- Bagi yang familiar dengan git, boleh menggunakan clone
    ```
    git clone https://github.com/WiraDKP/word_vector.git
    ```
...
- Jika sudah aman, maka akan muncul keterangan berikut, dan kita bisa mulai belajar. Semangat!
    ...
    ✓ Package telah terinstall dengan baik di dalam environment jcop_wv
