...
req = {
    ...
    "scikit-learn", "matplotlib", "ipywidgets", "nltk", "gensim", "plotly", "umap-learn", "xgboost", 
    "scikit-optimize", "jcopml", "luwiji"
}
env_name = "jcop_wv"
working_folder = "word_vector"
env_file = "env_jcop_wv.yml"
